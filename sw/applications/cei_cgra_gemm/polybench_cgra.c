    ...
    DATA_TYPE *C)
{
    ...
    mult_cte_m_v_kernel[44] = (mult_cte_m_v_kernel[44] & 0xFFFF0000) | GEMM_NK;
    mult_cte_m_v_kernel[49] = (mult_cte_m_v_kernel[49] & 0xFFFF0000) | GEMM_NK;
    mult_cte_m_v_kernel[54] = (mult_cte_m_v_kernel[54] & 0xFFFF0000) | GEMM_NK;

    mult_cte_m_v_cgra(GEMM_NI, GEMM_NJ, GEMM_NK, A, B, M);

    sum_cte_v_v_kernel[ 8] = *beta;
    sum_cte_v_v_kernel[18] = *beta;

    sum_cte_v_v_cgra(GEMM_NI, GEMM_NJ, M, C);
}
